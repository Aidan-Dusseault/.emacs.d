...
(when (eq system-type 'windows-nt)
  ...
  (setq w32-register-hot-key (kbd "A-q"))
  (setq w32-register-hot-key (kbd "A-w"))
  (setq w32-register-hot-key (kbd "A-e"))
  (setq w32-register-hot-key (kbd "A-a"))
  (setq w32-register-hot-key (kbd "A-s"))
  (setq w32-register-hot-key (kbd "A-z"))
  (setq w32-register-hot-key (kbd "A-x"))
  (setq w32-register-hot-key (kbd "A-c"))
  (setq w32-register-hot-key (kbd "A-v"))
  (setq w32-register-hot-key (kbd "A-f"))
  (setq w32-register-hot-key (kbd "A-b"))
  (setq w32-register-hot-key (kbd "A-g"))
  (setq w32-register-hot-key (kbd "A-h"))
  (setq w32-register-hot-key (kbd "A-u"))
  (setq w32-register-hot-key (kbd "A-j"))
  (setq w32-register-hot-key (kbd "A-n"))
  (setq w32-register-hot-key (kbd "A-i"))
  (setq w32-register-hot-key (kbd "A-k"))
  (setq w32-register-hot-key (kbd "A-o"))
  (setq w32-register-hot-key (kbd "A-l"))
  (setq w32-register-hot-key (kbd "A-;"))
  (setq w32-register-hot-key (kbd "A-'"))
  (setq w32-register-hot-key (kbd "A-<delete>"))
  (setq w32-register-hot-key (kbd "A-<return>"))
  )
